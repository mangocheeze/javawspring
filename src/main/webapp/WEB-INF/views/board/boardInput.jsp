...
<div class="container">
  <form name="myform" method="post">
    ...
    <table class="table table-bodered">
      ...
      <tr>
        <th>이메일</th>
        <td><input type="text" name="email" placeholder="이메일을 입력하세요" value="${email}" class="form-control"/></td> <!-- 여기의 value는 vo에 있는게아닌 변수에 담긴걸 뿌리겠단 소리 -->
      </tr>
      <tr>
        <th>홈페이지</th>
      ...
      <tr>
        <td colspan="2" class="text-center">
        	<input type="button" value="글올리기" onclick="fCheck()" class="btn btn-info"/> &nbsp;
