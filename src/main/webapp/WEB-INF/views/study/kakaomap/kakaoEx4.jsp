...
<head>
  ...
  <style>
        ...
        .placeinfo .title {font-weight: bold; font-size:14px;border-radius: 6px 6px 0 0;margin: -1px -1px 0 -1px;padding:10px; color: #fff;background: #d95050;background: #d95050 
url(https://t1.daumcdn.net/localimg/localimages/07/mapapidoc/arrow_white.png) no-repeat right 14px center;}
  ...
  <script>
      var address = '${vo.address}'
	    ...
	    if(${vo.address == null}){
          alert("검색결과가 없습니다. 초기값으로 검색합니다.");
          location.href = "${ctp}/study/kakaomap/kakaoEx4";
      }
...
<p><br/></p>
<div class="container">
  <h2>지역 검색 후 주변시설 찾기</h2>
  <hr/>
  <div>
      <form name="myform" method="post">
          <div>
              <font size="4"><b>DB에 있는 지역 주변시설 검색하기</b></font>
